...
public class MyDBHandler extends SQLiteOpenHelper{
  ...
  /*  public void updateProductIlosc(String productKod, String new_ProductIlosc, String new_ProductName){
        SQLiteDatabase db = getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COLUMN_PRODUCTNAME, new_ProductName);
        values.put(COLUMN_KOD, productKod);
        values.put(COLUMN_ILOSC, new_ProductIlosc);
