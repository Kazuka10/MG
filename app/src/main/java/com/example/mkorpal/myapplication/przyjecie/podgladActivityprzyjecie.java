...
import com.example.mkorpal.myapplication.WydaniestartActivity;
 ...
 */
public class podgladActivityprzyjecie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(podgladActivityprzyjecie.this, "Kliknieto przycisk usun", Toast.LENGTH_SHORT).show();
            }
        });
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(podgladActivityprzyjecie.this, "Kliknieto przycisk edytuj", Toast.LENGTH_SHORT).show();
            }
        });
       ...
       // ArrayList<String> theList = new ArrayList<>();
        ...
        if(numRows == 0){
            Toast.makeText(podgladActivityprzyjecie.this, "Baza danch jest pusta", Toast.LENGTH_SHORT).show();
        }
        else{
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
           ...
           /*    try {
              ...
              //  adapter.notifyDataSetChanged();
                Intent intent = new Intent(podgladActivityprzyjecie.this, PrzyjeciestartActivity.class);
